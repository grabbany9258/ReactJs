        ...
        <div>
            ...
            <div className="page-heading text-center">
                ...
                <div className="container zoomIn animated">
                    ...
                    <h1 className="page-title">OUR CAUSES <span className="title-under"></span></h1>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 col-sm-6">
                                ...
                                <div className="cause">
                                    ...
                                    <div className="progress cause-progress">
                                        <div className="progress-bar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" s>
                                            400$ / 1000$
                                        </div>
                                    </div>
