          ...
          <div className="row fadeIn animated">
            ...
            <div className="col-md-6">
              <h2 className="title-style-2">
                ABOUT SADAKA <span className="title-under"></span>
              </h2>

              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Necessitatibus, nulla quae possimus id fugit totam perspiciatis
              ...
              <div className="col-md-3 col-sm-6">
                <div className="about-us-col">
                  <div className="col-icon-wrapper">
                    <img
                      src="assets/images/icons/our-mission-icon.png"
                      alt=""
                    />
                  </div>
        ...
        <div className="our-team animate-onscroll fadeIn">
          <div className="container">
            <h2 className="title-style-1">
              Our Team <span className="title-under"></span>
            </h2>
