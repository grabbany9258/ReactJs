    ...
    ================================================== --> */}
            ...
            <div className="section-home our-causes animate-onscroll fadeIn">
                ...
                <div className="container">
                    ...
                    <h2 className="title-style-1">Our Causes <span className="title-under"></span></h2>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <div className="cause">
                                ...
                                <h4 className="cause-title"><a href="#">HUNGER AND POVERTY </a></h4>
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <div className="cause">
                                ...
                                <h4 className="cause-title"><a href="#">EDUCATION AND TRAINING</a></h4>
                                <div className="cause-details">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut at eros rutrum turpis viverra elementum semper quis ex. Donec lorem nulla, aliquam quis neque vel, maximus lacinia urna.
                                </div>
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <div className="cause">
                                ...
                                <h4 className="cause-title"><a href="#">HUMAN RIGHTS</a></h4>
                                <div className="cause-details">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut at eros rutrum turpis viverra elementum semper quis ex. Donec lorem nulla, aliquam quis neque vel, maximus lacinia urna.
                                </div>
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <div className="cause">
                                ...
                                <h4 className="cause-title"><a href="#">ARTS AND CULTURE </a></h4>
                                <div className="cause-details">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut at eros rutrum turpis viverra elementum semper quis ex. Donec lorem nulla, aliquam quis neque vel, maximus lacinia urna.
                                </div>
            ...
            <div className="section-home our-sponsors animate-onscroll fadeIn">
                ...
                <div className="container">
                    ...
                    <h2 className="title-style-1">Our Sponsors <span className="title-under"></span></h2>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <form className="form-donation">
                                ...
                                <h3 className="title-style-1 text-center">Thank you for your donation <span className="title-under"></span>  </h3>
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-md-12">
                                        <button type="submit" className="btn btn-primary pull-right" name="donateNow" >DONATE NOW</button>
                                    </div>
