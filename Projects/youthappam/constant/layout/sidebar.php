     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                     <li><a href="about.php" aria-expanded="false"><i class="fa fa-info-circle"></i><span class="hide-menu">Shedule</span></a></li>

                 <?php } ?>

                 <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                     <li><a href="" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Notice</span></a></li>
